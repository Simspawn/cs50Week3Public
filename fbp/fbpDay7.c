...
#include <time.h>
/*
    1/27/2025    (accidently dated as the 25th cause the last time I worked on it was the 24 and saw that date in the comment xD)
...
if (fgets(callingBuffer, size, stdin) != NULL)
{
    ...
    if (token != NULL)
    {
        ...
        {
            action->secondWord[0] = '\0';       // Null terminate that shit if there's no target.
        }
